...
KeyInfo getKeyBE(uint32_t c) {
    switch(c) {
        ...
        case U'm': return {51,false,false};
        ...
        case U'?': return {16,true,false};
        case U'*': return {37,true,false};
        case U'%': return {35,true,false};
        case U'>': return {100,true,false};

        // Ajout important : le point "."
